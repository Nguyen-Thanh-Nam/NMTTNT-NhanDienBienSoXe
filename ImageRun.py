...
#cv2.imshow("1. Anh sau khi chuyen xam",imgGrayscaleplate2)
...
cv2.imshow("2. Tang Do Tuong Phan",imgThreshplate2)
###############################################################
...
canny_image = cv2.Canny(imgThreshplate2, 250, 255)  # Canny Edge
...
if detected == 1:
    ...
    for screenCnt in screenCnt:
        ...
        mask = np.zeros(imgGrayscaleplate2.shape, np.uint8)
        ...
        imgThresh = imgThreshplate2[topx:bottomx, topy:bottomy]
